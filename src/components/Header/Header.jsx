    ...
    return (
        ...
        <header className="w-full max-w-screen-xl p-6 mx-auto ">
            <nav className="relative flex flex-row items-center justify-between">
                <div className="z-10 flex text-xl font-semibold text-center cursor-pointer logo basis-1/6" onClick={() =>
                    login?.currentUser?.data?.userDTO?.role != "admin"
                        ? navigate("/")
                        : navigate("/manage/product")
                }>
...

                {
                                    ...
                                    >
                                        <div className="z-10 flex items-center justify-end ml-16 text-sm font-medium text-gray-500 uppercase shopping basis-3/6 lg:basis-1/6 lg:justify-start">
                                            <div className="flex items-center cart ndv-top-menu-item">
                                                ...
                                                <span className="text-white bg-gray-500 ndv-badge-circle ">{quantity && quantity}</span>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div className='sm:hidden'>
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    <NavLink to="/update/password" className='block'>Đổi mật khẩu</NavLink>
                                                    <NavLink to="/update/infor" className='block'>Thay đổi thông tin</NavLink>
                                                    {login?.currentUser?.data?.userDTO?.role == "user" ? (
                                                        <NavLink to={`/order/user`} className='block'>Đơn mua</NavLink>
                                                    ) : (
                                                        <></>
                                                    )}
                    ...
                    )}
                    {
                        ...
                        <div className="flex auth_option gap-x-3">
                            <NavLink to="/login" className='bg-[#1eb853] p-2 rounded-lg text-white'>Đăng nhập</NavLink>
                            <NavLink
                                to="/signup"
