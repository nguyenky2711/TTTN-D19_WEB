        ...
        <div className='overflow-hidden'>
            <div className="text-center wrapper">
                <div className='text-center'>
                    ...
                    <p className='text-lg text-gray-500 my-7 w-[70%] mx-auto sm:w-full'>Với nhiều năm kinh nghiệm phục vụ trong mảng cây xanh, chúng tôi hiểu mức độ quan trọng trong công việc của mình là truyền tải đúng và đủ thông điệp của người tặng đến người nhận. </p>
            ...
            <div className="text-center wrapper" data-aos="fade-up" data-aos-delay="50" data-aos-duration="1000">
                ...
                <div className='grid lg:grid-cols-3' >
                    <div>
                        ...
                        <p className='my-[20px] text-xl'>Mr.Vu Ky</p>
                        <ul className='text-gray-500'>
                            <li>086-374-4962</li>
                            <li>vuky@gmail.com</li>
                        </ul>
                    </div>
                    <div>
                        <h2 className='text-xs font-bold tracking-widest text-gray-500 '>MANAGEMENT</h2>
                        <p className='my-[20px] text-xl'>Dang Vu</p>
                        <ul className='text-gray-500'>
                            <li>354-341-2750</li>
                            <li>nguyendangvu137@gmail.com</li>
                        </ul>
                    </div>
                    <div>
                        <h2 className='text-xs font-bold tracking-widest text-gray-500 '>SUPPORT</h2>
                        <p className='my-[20px] text-xl'>Tat Ky</p>
                        <ul className='text-gray-500'>
                            <li>531-403-0376</li>
                            <li>tatky@gmail.com</li>
                        </ul>
                    </div>
                </div>
